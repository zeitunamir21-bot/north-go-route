...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "NorthGo Booking — Isiolo ⇄ Nairobi Private Transport, Kenya" },
      { name: "description", content: "NorthGo booking: private transport between Isiolo and Nairobi, Kenya. Reserve your seat online, no upfront payment, pay on board." },
      { name: "author", content: "NorthGo" },
      { property: "og:site_name", content: "NorthGo" },
      { property: "og:title", content: "NorthGo Booking — Isiolo ⇄ Nairobi Private Transport" },
      { property: "og:description", content: "NorthGo booking: private transport between Isiolo and Nairobi. Reserve your seat online, pay on board." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "NorthGo Booking — Isiolo ⇄ Nairobi Private Transport" },
      { name: "twitter:description", content: "NorthGo booking: private transport between Isiolo and Nairobi. Reserve online, pay on board." },
